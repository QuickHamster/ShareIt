...
public class BookingDtoTest {
    ...
    void bookingInputDtoSerialize() throws Exception {
        BookingInputDto bookingInputDto = new BookingInputDto(LocalDateTime.now().plusDays(1), LocalDateTime.now().plusDays(2), 1L);
    ...
    void bookingOutputDtoSerialize() throws Exception {
        BookingOutputDto bookingOutputDto = new BookingOutputDto(1L, LocalDateTime.now().plusDays(1), LocalDateTime.now().plusDays(2), null, null, BookingStatus.WAITING);
