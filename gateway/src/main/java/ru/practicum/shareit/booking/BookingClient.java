...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> addBooking(long userId, BookingInputDto bookingInputDto) {
    ...
    public ResponseEntity<Object> getBookingsForAllItemsUser(long userId,
                                                             BookingState state,
                                                             Integer from,
                                                             Integer size) {
        Map<String, Object> parameters = Map.of("state", state.name(), "from", from, "size", size);
